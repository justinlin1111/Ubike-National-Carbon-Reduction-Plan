...
if __name__ == "__main__":
    for i in range(1, 12+1):
        # 確保資料夾存在，不存在會直接創建資料夾
        os.makedirs(r"youbike_dataset/processed_data_rent", exist_ok=True)
        os.makedirs(r"youbike_dataset/processed_data_return", exist_ok=True)
        os.makedirs(r"youbike_dataset/net_flow_data", exist_ok=True)

        csv_to_hourly_rent_count(
            r"youbike_dataset/raw_data_csv/2023" + str(i).zfill(2) + "_轉乘YouBike2.0票證刷卡資料.csv",
            r"youbike_dataset/processed_data_rent/2023" + str(i).zfill(2) + ".csv"
        )

        csv_to_hourly_return_count(
            r"youbike_dataset/raw_data_csv/2023" + str(i).zfill(2) + "_轉乘YouBike2.0票證刷卡資料.csv",
            r"youbike_dataset/processed_data_return/2023" + str(i).zfill(2) + ".csv"
        )

        csv_to_hourly_net_flow(
            r"youbike_dataset/raw_data_csv/2023" + str(i).zfill(2) + "_轉乘YouBike2.0票證刷卡資料.csv",
            r"youbike_dataset/net_flow_data/2023" + str(i).zfill(2) + ".csv"
        )
